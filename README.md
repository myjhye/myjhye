...
2\. 토스 앱인토스 미니앱 (Mobile WebView App) -- 포켓몬 닮은꼴 찾기, 직장인 공감 아카이브
----------------------------

**목표**\
토스의 주 사용층이 20~40대라는 점을 착안해, <br />
해당 연령대가 반응하는 트렌드와 콘텐츠 유형을 빠르게 검증하고 실제 유입과 수익화가 가능한 구조 제작
...
-   20~40대 사용자 성향을 기반으로 한 콘텐츠 콘셉트 설계
    -   캐주얼 참여형 콘텐츠(포켓몬 닮은꼴)
    -   직장인 공감형 아카이브 콘텐츠
...
**성과**
-   직장인 공감 아카이브 미니앱 출시 직후 MAU 1,000명 이상 달성
-   단순 배포가 아닌, 실제 사용자 유입과 반응 데이터를 통해 콘텐츠 방향성과 수익화 가능성을 검증
